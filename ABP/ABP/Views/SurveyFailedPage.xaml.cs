...
namespace ABP.Views
{
    public partial class SurveyFailedPage : ContentPage
    {
        ...
        public SurveyFailedPage(cSurveyInputResult item)
        {
            InitializeComponent();
            Title = "Survey Failed";
        ...
        private void PopulateFailedDropDown()
        {
            try
            {
                p_lsFailedReasons = cMain.p_cDataAccess.FetchAllSurveyFailedReasons();


                //Add please choose to the list.
                cmbFailedSurvey.Items.Add(cSettings.p_sPleaseChoose);
