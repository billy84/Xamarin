...
''' </summary>
Public NotInheritable Class SurveyResult
    Inherits Page
...
#End Region
    ...
    Private Sub btnSuccessfull_Click(sender As Object, e As RoutedEventArgs) Handles btnSuccessfull.Click

        Try

            Call Me.Frame.Navigate(GetType(SurveySuccessful))
    ...
    Private Sub btnSurveyFailed_Click(sender As Object, e As RoutedEventArgs) Handles btnSurveyFailed.Click

        Try

            Call Me.Frame.Navigate(GetType(SurveyFailed))
