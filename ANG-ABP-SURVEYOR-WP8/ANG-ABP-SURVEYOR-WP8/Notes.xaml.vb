...
#End Region
    ...
    Public Sub New()
        ...
        Try
            ...
            Dim lsNotes As New List(Of cNote)

            Dim cNot As New cNote
            cNot.CommentTitle = "LYONC00 @ 12:24 18/08/2015"
            cNot.Comment = "We need to diagnose why this survey is always being surveyed incorrectly."
            Call lsNotes.Add(cNot)

            cNot = New cNote
            cNot.CommentTitle = "PEACOB00 @ 13:45 17/08/2015"
            cNot.Comment = "The survey has been completed and there seem to be some issues, see email."
            Call lsNotes.Add(cNot)

            Me.lvNotes.ItemsSource = lsNotes
