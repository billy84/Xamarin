...
''' </summary>
Public NotInheritable Class LoginFirstOption
    Inherits Page
...
#End Region
    ...
    Private Sub btnSetSurveyDates_Click(sender As Object, e As RoutedEventArgs) Handles btnSetSurveyDates.Click

        Try

            Call Me.Frame.Navigate(GetType(SurveyDatesFilters))
    ...
    Private Sub btnProcessSurveys_Click(sender As Object, e As RoutedEventArgs) Handles btnProcessSurveys.Click

        Try

            Call Me.Frame.Navigate(GetType(WorkForToday))
