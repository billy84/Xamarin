...
namespace ANG_ABP_INSTALLER_APP.Views
{
    ...
    /// </summary>
    public sealed partial class SetInstallationPhotosPage : Page
    {
        ...
        public SetInstallationPhotosPage()
        {
        ...
        /// <param name="e"></param>
        private async void SetInstallationPhotosPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (sender.GetType() == typeof(Image))
                {
                    ...
                    if (imgImage.DataContext.GetType() == typeof(cDisplayPhoto))
                    {
                        ...
                        this.Frame.Navigate(typeof(ViewImagePage), cPhoto);
